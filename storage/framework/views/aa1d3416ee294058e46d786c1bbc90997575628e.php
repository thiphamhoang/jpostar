...
<div class="col-md-12">
    <div class="form-group">
        <label class="font-weight-bold"><i class="fas fa-edit"></i> Nội dung 2</label>
        <textarea class="form-control" id="post_edit_2" rows="3" name="content_2"><?php echo e($post->content_2); ?></textarea>
        <script>
            tinymce.init({
                editor_selector : "mceEditor",
                selector: '#post_edit_2',height: 500,
                relative_urls:false,
...
</div><?php /**PATH E:\xampp\htdocs\jpostar\app\Modules/Post/Views/inc_edit/content_2.blade.php ENDPATH**/ ?>