...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Thêm mới | <?php echo e($post_type -> name); ?>
        ...
        <form action="new" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="text"
                                        ...
                                        onkeyup="ChangeToSlug();" value="<?php echo e(old('title')); ?>" maxlength="500">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="url_post" name="url"
                                        value="<?php echo e(old('url')); ?>" maxlength="500">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <?php echo $__env->make('Post::inc/'.$feild, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <!-- seo bai viet -->
                    <?php echo $__env->make('Post::IV_seo_post_new', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="created_at"
                                    placeholder="Ngày" name="created_at" value="<?php $ldate = new DateTime(); echo $ldate->format('d-m-Y'); ?>">
                                </div>
                            <script>
...
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\jpostar\app\Modules/Post/Views/V_post_new.blade.php ENDPATH**/ ?>