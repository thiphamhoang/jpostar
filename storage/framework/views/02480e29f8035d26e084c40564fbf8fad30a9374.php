...
<div class="col-md-12">
    <div class="form-group">
        ...
        <textarea class="form-control" id="post_edit_2" rows="3" name="content_2"></textarea>
        <script>
            tinymce.init({
...
</div><?php /**PATH E:\xampp\htdocs\jpostar\app\Modules/Post/Views/inc/content_2.blade.php ENDPATH**/ ?>