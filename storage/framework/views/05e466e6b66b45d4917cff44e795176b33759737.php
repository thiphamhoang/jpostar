<div class="box box-info collapsed-box">
    ...
    <div class="box-body">
        <div class="form-group google_snipet" style="padding: 10px; background-color: #f0f0f1; border-radius: 5px;">
            <div class=""><?php echo e(asset('')); ?><span class="google_url"> </span></div>
        ...
        <div class="form-group">
            ...
            <textarea id="seo_des" class="form-control" rows="3" name="des_seo"
                placeholder="Bạn điền mô tả bài viết"><?php echo e(old('des_seo')); ?></textarea>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" rows="3" name="key_seo"
                placeholder="Bạn điền từ khóa bài viết, cách nhau dấu phẩy" value="<?php echo e(old('key_seo')); ?>">
...
<?php /**PATH E:\xampp\htdocs\jpostar\app\Modules/Post/Views/IV_seo_post_new.blade.php ENDPATH**/ ?>