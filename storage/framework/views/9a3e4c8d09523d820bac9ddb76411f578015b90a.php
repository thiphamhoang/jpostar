<div class="modal fade" id="new_row_custome" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
   <form action="<?php echo e(asset('admin/theme/'.$theme_id.'/row_new')); ?>" method="post" enctype="multipart/form-data">
...
</div><?php /**PATH E:\xampp\htdocs\jpostar\app\Modules/Theme/Views/inc/row_custome_new.blade.php ENDPATH**/ ?>