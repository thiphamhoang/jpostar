...
<div class="col-md-12">
    <div class="form-group row">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="da_date" value="{{$post->da_date}}">
        </div>
        <div class="col-md-6">
            <label class="font-weight-bold mt-2"> Địa chỉ</label>
            <input type="text" class="form-control" name="da_address" value="{{$post->lp_title_1}}">
        </div>
...
<div class="col-md-12">
    <div class="form-group">
        ...
        <textarea type="textarea" id="da_tongQuan" class="form-control" name="da_tongQuan"  >{{$post->da_tongQuan}}</textarea>
...
<div class="col-md-12">
    <div class="form-group">
        ...
        <textarea type="textarea" id="da_tinhNang" class="form-control" name="da_tinhNang"  >{{$post->da_tinhNang}}</textarea>
...
<div class="col-md-12">
    <div class="form-group">
        ...
        <textarea type="textarea" id="da_moHinh" class="form-control" name="da_moHinh"  >{{$post->da_moHinh}}</textarea>
        {{F_tinymce('da_moHinh')}}
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
        ...
        <textarea type="textarea" id="da_chiPhi" class="form-control" name="da_chiPhi"  >{{$post->da_chiPhi}}</textarea>
        {{F_tinymce('da_chiPhi')}}
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
        ...
        <textarea type="textarea" id="da_loTrinh" class="form-control" name="da_loTrinh"  >{{$post->da_loTrinh}}</textarea>
