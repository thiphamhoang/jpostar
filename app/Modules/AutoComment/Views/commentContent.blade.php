        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-left">
                    <form action="{{asset('admin/autocomment/commentContent/new_multi')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="">Mỗi nội dung 1 dòng</label>
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive no-padding">
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($commentContent as $key => $val)
                                <tr>
                                    <!-- tene -->
                                    <td class="">
                                        {{$val->content}}
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-left">
                                                    <form action="{{asset('admin/autocomment/commentContent/edit/'.$val->id)}}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="form-group">
                                                            <label>Nội dung</label>
                                                            <textarea  name="content" class="form-control">{{$val->content}}</textarea>
                                                        </div>
                    ...
                    <div class="box-footer clearfix">
                        {{$commentContent->appends(request()->input()) ->links()}}
                    </div>
