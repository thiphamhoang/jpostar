...
<div class="page-head">
    <div class="text-center">
        <div class="page-title-mod">
            ...
            <img src="{{asset('upload/theme/intro-bg.jpg')}}" class="w-100">
        </div>
...
<div class="my-3">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="my-3">
                    <ul class="nav nav-pills mb-3 justify-content-center pill-intro" id="pills-tab" role="tablist">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        @foreach($row_body as $keyc => $row)
                            <div class="tab-pane fade @if($keyc == 0) show active @endif" id="pills-{{$row->style}}" role="tabpanel" aria-labelledby="pills-{{$row->style}}-tab">
                                ...
                                @include('fontend/intro/'.$row->style)
