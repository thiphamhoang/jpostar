                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center">
                                <a href="{{asset('du-an')}}" class="readmore btn btn-primary rounded-pill">Xem tất cả</a>
                        </div>
                    </div>
                </div>
