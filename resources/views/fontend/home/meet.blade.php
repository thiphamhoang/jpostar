            ...
            <div class="container">
                ...
                <div class="newtestimonials-section__box wow fadeInUp">
                    ...
                    <div class="web3testimon-section__list owl-carousel">
                        ...
                        <?php 
                            $slide_fList = App\Model\M_slide_img::where('slide_id',$row->slide_id)->get();
                        ?>
                        @foreach($slide_fList as $key => $slide_f)
                            <div class="web3testimon-section__item">
                                <div class="web3testimon-section__txt">{{$slide_f->title}}</div>
                                <div>{{$slide_f->des}}</div>
                                <div class="web3testimon-section__logo">
                                    <img class="web3testimon-section__img lazyload"
                                        data-src="{{asset('source/slide/'.$slide_f->img)}}" alt=""
                                        src="d{{asset('source/slide/'.$slide_f->img)}}" />
                                    <div class="web3testimon-section__team">
                                        <div class="web3testimon-section__name">{{$slide_f->button}}</div>
                                        <!-- <div class="web3testimon-section__position">{{$slide_f->des}} </div>-->
