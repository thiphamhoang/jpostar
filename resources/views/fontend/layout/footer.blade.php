        ...
        <div class="footer__nav">
            <div class="footer__logo-wrapper">
                <a href="" class="footer__logo">
                    <img data-src="{{ asset('/source/theme/' . $row->img) }}" alt="NinjaPromo logo" width="130"
                        height="46" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                        class="lazyload"
