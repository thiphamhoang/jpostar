...
<head>
    ...
    <meta property="og:image" content="{{ asset('source/theme/' . $favicon) }}" />
    <meta property="og:description"        content="{{$des}}" />

    <meta name="twitter:image" content="{{ asset('source/theme/' . $favicon) }}">
    ...
    <style id='global-styles-inline-css'>
        .menu-item-has-children:hover .mm-sub-menu {
            display: block;
        }
        ul.mm-sub-menu {
            display: none;
    ...
    <link rel="icon" type="image/x-icon" href=" {{ asset('source/theme/' . $favicon) }}">
    <link rel="icon" href="{{ asset('source/theme/' . $favicon) }}" sizes="32x32" />
    <link rel="icon" href="{{ asset('source/theme/' . $favicon) }}" sizes="192x192" />
    <link rel="apple-touch-icon" href="{{ asset('source/theme/' . $favicon) }}" />
    <meta name="msapplication-TileImage" content="{{ asset('source/theme/' . $favicon) }}" />
