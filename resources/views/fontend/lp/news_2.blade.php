...
<?php 
     $row = App\Model\M_theme_row::where('style', 'news_2')->where('status','on')->first();
                        ...
                        <div class="owl-item @if($key <=3)active @endif" style="width: 360px; margin-right: 30px;">
                            <div class="newarticle-awards__item">
                                    ...
                                    <div class="">
                                        ...
                                        <img
                                            data-src="{{asset('source/post/'.$post_r->img)}}"
                                            alt=""
                                            src="{{asset('source/post/'.$post_r->img)}}"
                                            class=" lazyloaded w-100" style="height: 150px; width:100%">
